  ...
  export default {
    ...
    data() {
      return {
        ...
        imageFile: null, imagePreview: null, loading: false, categories: []
      };
    },
    watch: {
      opportunity: {
      ...
      show(visible) { if(visible && !this.categories.length) this.loadCategories(); }
    },
    ...
    methods: {
      ...
      handleImageChange(event) {
        ...
        if (!['image/jpeg','image/png','image/jpg'].includes(file.type)) 
          return alert("Format non supporté (JPG/PNG uniquement)");
