            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-5">
              <div class="flex items-center">
                <div class="h-12 w-12 rounded-full overflow-hidden bg-gray-200 flex-shrink-0">
                  <img :src="application?.image || 'https://via.placeholder.com/48'" alt="" class="h-full w-full object-cover" />
                </div>
                <div class="ml-4">
                  <div class="font-medium text-gray-900">{{ application?.prenom }} {{ application?.nom }}</div>
                  <div class="text-sm text-gray-500">
                    {{ application?.email }}
                  </div>
                  <div class="text-xs text-gray-400 mt-1">
                    Candidature pour: {{ application?.titre }}
                  </div>
                </div>
              </div>
            </div>
