            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <div>
                ...
                <input 
                    ...
                    type="date"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#00B3AD] focus:ring-[#00B3AD]"
                    :class="{ 'border-red-300': validationErrors.date_naissance }"
                />
                <p v-if="validationErrors.date_naissance" class="mt-1 text-sm text-red-600">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    type="text"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#00B3AD] focus:ring-[#00B3AD]"
                    :class="{ 'border-red-300': validationErrors.telephone_1 }"
                    />
                    <p v-if="validationErrors.telephone_1" class="mt-1 text-sm text-red-600">
                    {{ validationErrors.telephone_1 }}
                    </p>
                </div>
                <div>
                    ...
                    type="text"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#00B3AD] focus:ring-[#00B3AD]"
                    :class="{ 'border-red-300': validationErrors.telephone_2 }"
                    />
                    <p v-if="validationErrors.telephone_2" class="mt-1 text-sm text-red-600">
                    {{ validationErrors.telephone_2 }}
                    </p>
                </div>
                </div>
